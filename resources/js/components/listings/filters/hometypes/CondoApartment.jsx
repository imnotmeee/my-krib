...
let strs = "Condo Apt, Comm Element Condo, Co-Op Apt, Co-Ownership Apt, Phased Condo, Apartment, Condo Apartment";

const CondoApartment = ({setTypes}) => {
